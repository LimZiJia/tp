...
public class CommandTestUtil {
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        List<Person> expectedClientFilteredList = new ArrayList<>(actualModel.getFilteredClientList());
        List<Person> expectedHousekeeperFilteredList = new ArrayList<>(actualModel.getFilteredHousekeeperList());
